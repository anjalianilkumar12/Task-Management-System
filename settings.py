...
SECRET_KEY = 'django-insecure-vnss!=6=8q3(x4e$$31n=dai!o-c55el=86bj(_a+d#zsr7#sr'
...
DATABASES = {
    "default": {
        ...
        "NAME": venv("DB_NAME"),
        "USER": venv("DB_USER"),
        "PASSWORD": venv("DB_USER_PASSWORD"),
        "HOST": venv("DB_HOST"),
        "PORT": venv("DB_PORT"),
    }
}
...
CHANGE_PASSWORD_URL = venv("CHANGE_PASSWORD_URL")
TEST_EMAIL = venv("TEST_EMAIL")
